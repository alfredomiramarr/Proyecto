...
<head>
	...
	<header align="right" background="white">
		<style>
			...
			.body{
				font-family: 'Prompt', sans-serif;
				background-image: url('images/haciendabg.jpg');
...
<div class="menu" align="center">
	  ...
	  <a class="active" href="#">HACIENDAS</a>
...
<body class="body">
			...
			<div class="paleBlueRows" align="center">
				<table class="paleBlueRows" align="center">
					...
					$sql = "SELECT Z.Zone, H.Hacienda_ID, H.Name, H.Location, H.Creation_Date, H.Status FROM C_Hacienda H, C_Zone Z WHERE Z.Zone_ID = H.Zone_ID AND H.Status='Active'";
					...
					echo "<td> <a href='editar_hacienda.php?id=".$row["Hacienda_ID"]."'>EDITAR </a><br>
					<a href='eliminar_hacienda.php?id=".$row["Hacienda_ID"]."' style='color:red;''>ELIMINAR</a></div></td>";
			...
			<div class="text-center p-t-40 p-b-20">
					<a href="new_hacienda.php" class="txt1">
						Nueva Hacienda
					</a>
				</div>
		</div>

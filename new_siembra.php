...
<head>
	...
	<header align="center" background="white">
		<style>
			...
			.body{
				font-family: 'Prompt', sans-serif;
				background-image: url('images/siembra-bg.jpg');
...
<body class="body">
		...
		<div class="tabla10 p-l-50 p-r-50 p-t-30 p-b-30">
			<form class="login100-form validate-form" method="post" action="alta_siembra.php" enctype="multipart/form-data">
				...
				<div class="wrap-input10 validate-input m-b-20" >
					<select class="input100" name="h" required="required">
				        <option value="0">Hacienda de siembra:</option>
				        <?php
				          if(!empty($hacienda)){
				          foreach ($hacienda as $ob2) {
				            echo '<option value="'.$ob2->getHaciendaId().'">'.$ob2->getName().'</option>';
				            //$contador = $contador + 1;
				        	}
				          }
				        ?>
				...
				<div class="wrap-input10 validate-input m-b-20" >
					<select class="input100" name="c" required="required">
				        <option value="0">Cultivo sembrado:</option>
				        <?php
				          if(!empty($hacienda)){
				...
				<div class="wrap-input10 validate-input m-b-20" >
					<input class="input100" type="number" name="q" placeholder="Cantidad sembrada de cultivos" required="required">
					<span class="focus-input100"></span>
				</div>

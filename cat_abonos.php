	...
	<?php endif; ?>
			...
			<div class="tabla10 p-l-50 p-r-50 p-t-30 p-b-30">
				...
				<table class="paleBlueRows" align="center">
					...
					$sql = "SELECT * FROM C_Fertilizer WHERE Status='Active'";
					...
					echo "<td> <a href='editar_abono.php?id=".$row["Fertilizer_ID"]."'>EDITAR </a><br>
					<a href='eliminar_abono.php?id=".$row["Fertilizer_ID"]."' style='color:red;''>ELIMINAR</a></div></td>";

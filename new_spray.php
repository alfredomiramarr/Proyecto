...
<body class="body">
		...
		<div class="tabla10 p-l-50 p-r-50 p-t-30 p-b-30">
			<form class="login100-form validate-form" method="post" action="alta_spray.php" enctype="multipart/form-data">
				...
				<p>Insertar imagen</p>		
				<div class="wrap-input10 validate-input m-b-25" >
					<input class="input100" type="file" name="i" placeholder="Imagen">
					<span class="focus-input100"></span>
				</div>		

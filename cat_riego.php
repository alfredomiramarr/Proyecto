...
<body class="body">
			...
			<div class="paleBlueRows" align="center">
				<table class="paleBlueRows" align="center">
					...
					$sql = "SELECT * FROM C_Irrigation WHERE Status = 'Active'";
					...
					echo "<td> <a href='editar_riego.php?id=".$row["Irrigation_ID"]."'>EDITAR </a><br>
					<a href='eliminar_riego.php?id=".$row["Irrigation_ID"]."' style='color:red;''>ELIMINAR</a></div></td>";
			...
			<div class="text-center p-t-40 p-b-20">
					<a href="new_riego.php" class="txt1">

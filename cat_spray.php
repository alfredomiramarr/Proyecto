...
<body class="body">		
			<div class="tabla10 p-l-50 p-r-50 p-t-30 p-b-30">
				...
				<table class="paleBlueRows" align="center">
					...
					$sql = "SELECT * FROM C_Spray WHERE Status='Active'";
					...
					echo '<td><img src="'.$row["Spray_Image"].'" alt="'.$row["Spray_Image"].'"style="width:60%;"></td>';
					echo "<td> ". $row ["Spray_Name"]. "</td>";
					echo "<td> ". $row ["Spray_Desc"]. "</td>";

					echo "<td> <a href='editar_spray.php?id=".$row["Spray_Id"]."'>EDITAR </a><br>
					<a href='eliminar_spray.php?id=".$row["Spray_Id"]."' style='color:red;''>ELIMINAR</a></div></td>";
			...
			<div class="text-center p-t-40 p-b-20">
					<a href="new_spray.php" class="txt1">
						Nuevo DDT
					</a>
				</div>
		</div>

...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" href="style/css/menu-bar2.css">
<!--===============================================================================================-->
</head>
<body>
		...
		<div class="container-login100" style="background-image: url('images/banana-back.jpg');">
			...
			<div class="tabla10 p-l-50 p-r-50 p-t-30 p-b-30">
				...
				<table class="paleBlueRows" align="center">
					...
					echo '<td><img src="'.$row["Crop_Img"].'" alt="'.$row["Crop_Img"].'"style="width:60%;"></td>';
					echo "<td> ". $row ["Crop_Name"]. "</td>";
					echo "<td> ". $row ["Crop_Type"]. "</td>";
					echo "<td> ". $row ["Crop_Quant"]. "</td>";
					
					echo "<td> <a href 'editar.php?no=".$row["Crop_ID"]."'> <button type='submit'  name='editar' class='btn'>Editar</button></a><p>...</p>
					<a href 'modificar.php?no=".$row["Crop_ID"]."'> <button type='submit' name='eliminar' class='btn'>Eliminar</button></a></div></td>";

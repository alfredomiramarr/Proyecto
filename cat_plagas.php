		...
		<div class="container-login100" style="background-image: url('images/banana-back.jpg');">
			...
			<div class="paleBlueRows" align="center">
				<table class="paleBlueRows" align="center">
					...
					echo "<td> <a href 'editar.php?no=".$row["Plague_ID"]."'> <button type='submit'  name='editar' class='btn'>Editar</button></a><p>...</p>
					<a href 'modificar.php?no=".$row["Plague_ID"]."'> <button type='submit' name='eliminar' class='btn'>Eliminar</button></a></div></td>";
					echo "</tr>";
					}

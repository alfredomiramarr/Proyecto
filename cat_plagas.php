...
<body class="body">
			...
			<div class="paleBlueRows" align="center">
				<table class="paleBlueRows" align="center">
					...
					$sql = "SELECT * FROM C_Plague WHERE Status = 'Active'";
					...
					echo "<td> <a href='editar_plaga.php?id=".$row["Plague_ID"]."'>EDITAR </a><br>
					<a href='eliminar_plaga.php?id=".$row["Plague_ID"]."' style='color:red;''>ELIMINAR</a></div></td>";
					echo "</tr>";
					}
			...
			<div class="text-center p-t-40 p-b-20">
					<a href="new_plaga.php" class="txt1">
						Nueva Plaga
					</a>
				</div>
		</div>

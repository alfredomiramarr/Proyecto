...
<head>
	...
	<header align="right" background="white">
		<style>
			...
			.body{
				font-family: 'Prompt', sans-serif;
				background-image: url('images/bgcatddt.jpg');
		...
		<div class="topnav" font-family= 'Prompt';>
			  <a href="home_owner.php">Inicio</a>
			  
			  <a  class="active" href="ocat_cultivos.php">Cat&#225logos</a>
...
<div class="menu" align="center">
	  <a href="ocat_cultivos.php">CULTIVOS</a>
	  <a href="ocat_abonos.php">FERTILIZANTES</a>
	  <a class="active" href="#">DDT</a>
	  <a href="ocat_plagas.php">PLAGAS</a>
	  <a href="ocat_riego.php">RIEGO</a>
...
<body class="body">
			...
			<div class="tabla10 p-l-50 p-r-50 p-t-30 p-b-30">
				...
				<table class="paleBlueRows" align="center">
					...
					echo '<td><img src="'.$row["Spray_Image"].'" alt="'.$row["Spray_Image"].'"style="width:30%;"></td>';
					echo "<td> ". $row ["Spray_Name"]. "</td>";
					echo "<td> ". $row ["Spray_Desc"]. "</td>";

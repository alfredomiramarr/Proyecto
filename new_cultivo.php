...
<body class="body">
		...
		<div class="tabla10 p-l-50 p-r-50 p-t-30 p-b-30">
			<form class="login100-form validate-form" method="POST" action="alta_cultivo.php" enctype="multipart/form-data">
				...
				<div class="wrap-input10 validate-input m-b-25" >
					<input class="input100" type="number" name="q" placeholder="Cantidad Existencia" required="required">
					<span class="focus-input100"></span>
				</div>
				<p>Insertar imagen</p>	
				<div class="wrap-input10 validate-input m-b-25" >
